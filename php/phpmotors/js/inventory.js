...
data.forEach(function (element) { 
  ...
  dataTable += `<td><a href='/phpmotors/vehicles?action=mod&id=${element.invId}' title='Click to
  modify'>Modify</a></td>`; 
  dataTable += `<td><a href='/phpmotors/vehicles?action=del&id=${element.invId}' title='Click to 
